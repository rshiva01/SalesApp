...
const SearchCustomers = () => {
    return(
        <View style = {styles.mainContainer}>
            ...
            <View  style = {{borderWidth:1, borderColor:'#F6B100', padding: 30, borderRadius:15, marginVertical:10, backgroundColor:'#012E3C'}}>
                <View style = {{flexDirection:'row', alignItems:'center'}} >
                    <View style = {{height:20, width:20, backgroundColor:'#2A677A', justifyContent:'center', alignItems:'center', borderRadius:10}}>
                        <Image source={require('../assets/customerIcon.png')} resizeMode="contain"/>
                    </View>
                    <Text style = {{color:'#D5EAF1', paddingHorizontal:5}}>Customers</Text>
                </View>
