    ...
    return(
        <View style = {styles.salesLogBox} >
            <View style = {styles.boxHeader} >
                <View style = {{flexDirection: 'row', justifyContent: 'space-around'}} >
                    <View style = {styles.paidBox} >
                        <Text style = {{color: '#FFFFFF', fontSize: 10, textAlign: 'center'}} >Paid</Text>
                    </View>
                ...
                <View>
                    ...
                    <Text style = {{color: '#FFFFFF', fontSize: 12}} >{props.paymentMode}</Text>
                </View>
            </View>
            ...
            <View style = {{flexDirection: 'row', justifyContent: 'space-evenly', alignItems: 'center'}} >
                <Text style = {{color: '#D5EAF1', fontSize: 12, fontStyle:'italic'}} >{hour}:{min}</Text>
                <IconButton icon  = {require('../../assets/arrowIcon.png')}/>
                <Text style = {{color: '#D5EAF1', fontSize: 12}} >ID: 678900</Text>
            </View>
            <View style = {{flexDirection: 'row-reverse', marginHorizontal: 10, marginBottom: 10}} >
                <Text style = {{textDecorationLine: 'underline', color: '#F6B100', fontSize:12}} >Edit</Text>
            </View>
        </View>
    )
}
...
const DashboardFilled = () => {
    return(
        <View style = {styles.container} >
            ...
            <ScrollView>
                <SalesEntry name = "John Doe" tzs='12,450' paymentMode='Cash' ap='12,450' ad='0.0'/>
                <SalesEntry name = "John Doe" tzs='12,450' paymentMode='Cash' ap='12,450' ad='0.0'/>
                <SalesEntry name = "John Doe" tzs='12,450' paymentMode='Cash' ap='12,450' ad='0.0'/>
                <SalesEntry name = "John Doe" tzs='12,450' paymentMode='Cash' ap='12,450' ad='0.0'/>
                <SalesEntry name = "John Doe" tzs='12,450' paymentMode='Cash' ap='12,450' ad='0.0'/>
