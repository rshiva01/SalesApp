...
const Questions = (props: QuestionPros) => {
    return(
        <View style = {{flexDirection:'row', justifyContent:'space-between', alignItems:'center', marginLeft: 20}} >
            ...
            <IconButton icon={require('../assets/arrowIcon.png')} iconColor='#78ADBE' />
        </View>
    )
}
...
const FAQ = (navigation:any) => {
    ...
    <View style = {styles.mainContainer} >
        <View style = {{flexDirection: 'row', justifyContent: 'space-between'}} >
            ...
            <View>
                <IconButton icon={require('../assets/bellIcon.png')} iconColor='#F6B100' size={20} onPress={()=>(navigation.navigate('Notifications'))} />
            </View>
        </View>
        <Questions ques='Lorem Ipsum is simply dummy text' />
        <Divider theme={{ colors: { primary: '#2A677A' } }} style={{marginHorizontal:20}}  />
        <Questions ques='Lorem Ipsum is simply dummy text' />
        <Divider theme={{ colors: { primary: '#2A677A' } }} style={{marginHorizontal:20}}  />
        <Questions ques='Lorem Ipsum is simply dummy text' />
        <Divider theme={{ colors: { primary: '#2A677A' } }} style={{marginHorizontal:20}}  />
