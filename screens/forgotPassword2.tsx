    ...
    return(
        <View style = {styles.mainContainer} >
            ...
            <View style = {{flexDirection:'row', justifyContent: 'center', alignItems:'center', marginTop:150}} >
                <Text style = {{color: '#FFFFFF', fontSize:14}}>Didn't recieve OTP?</Text>
                <Button textColor='#F6B100' >
                    Resend OTP
                </Button>
            </View>
            <View style={styles.buttonContainer}>
                <TouchableOpacity style={styles.logInButton} onPress={()=>{navigation.navigate('ChangePassword')}} >
