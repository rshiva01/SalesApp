...
const SearchProducts = () => {
    return(
        <View style = {styles.mainContainer}>
            ...
            <View  style = {{paddingVertical: 20,paddingHorizontal:30, borderRadius:15, marginVertical:10, backgroundColor:'#012E3C', height:500}}>
                <View>
                    <Text style = {styles.itemNameStyle}>Britannia</Text>
                    <Text style = {styles.priceStyle}>Unit price - TZS 5000</Text>
                    <Divider style = {styles.dividerStyle} theme={{ colors: { primary: '#08485C' } }}/>
                </View>
                <View>
                    <Text style = {styles.itemNameStyle}>Britannia</Text>
                    <Text style = {styles.priceStyle}>Unit price - TZS 5000</Text>
