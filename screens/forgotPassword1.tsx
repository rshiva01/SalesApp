...
import { LogoContainer,Dividers, YellowText, Content, UnsecuredTextBox} from './login'
    ...
    return(
        <View style = {styles.mainContainer} >
            ...
            <View style={styles.buttonContainer}>
                <TouchableOpacity style={styles.logInButton} onPress={()=>{navigation.navigate('ForgotPassword2')}} >
